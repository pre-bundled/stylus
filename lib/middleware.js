...
var stylus = require('./stylus')
  , semver = require("../pre-bundled/node_modules/semver")
  , fs = require('fs')
  , url = require('url')
  , dirname = require('path').dirname
  , join = require('path').join
  , sep = require('path').sep
  , debug = require("../pre-bundled/node_modules/debug")('stylus:middleware')
  , mkdir = semver.satisfies(process.version, '>=10.12.0') ? fs.mkdir : require("../pre-bundled/node_modules/mkdirp");
